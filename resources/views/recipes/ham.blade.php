<x-app-layout>
    ...
    <body>
        ...
        <div class="container my-5 p-4 title-product text-center">
            <h1 class="my-4">HAM</h1>
            <div class="row mx-5 text-center">
                @foreach ($hams as $ham)
                    <div class="col mx-5">
                        <div class="card mb-3">
                            <img src="/storage/images/{{$ham->product_image}}" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h6 class="card-title mb-2">{{$ham->product_name}}</h6>
                                <p class="card-text mb-1">&#8369; {{$ham->product_price}}</p>
                                <a class="btn btn-outline-light btn-cart text-light" style="background-color: #000000;" href="{{ route('add.to.cart', $ham->product_id) }}">ADD TO CART</a>
                            </div>
                        </div>
                    </div>
                @endforeach
