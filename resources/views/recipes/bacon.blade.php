<x-app-layout>
    ...
    <body>
        ...
        <div class="container-fluid mt-5 my-5 py-5 title-product text-center">
            <h1 class="container mt-1">BACON</h1>
                ...
                <div class="col">
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-outline-light btn-cart text-light" style="background-color: #000000;" href="{{ route('add.to.cart', $bacon->product_id) }}">ADD TO CART</a>
                        </div>
                    </div>
                </div>
                @endforeach
