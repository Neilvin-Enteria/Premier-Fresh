...
<div class="container my-5 py-1 title-product text-center">
    <div class="container mt-5 my-5 text-center text-dark">
        <h1 class="mt-5" style="font-family: Playfair Display;">SAUSAGE LEFTOVER</h1>
                ...
                <div class="col-lg-7 col-md-12 card">
                    <div class="" >
                        <div class="card-body mt-0 ">
                            <p>
                                <a class="btn-light btn-outline-light text-dark" data-toggle="collapse" href="#collapsepancit-canton"aria-expanded="false" aria-controls="collapsepancit-canton" style="text-decoration: none;">
                                    <h3 class="card-title premium-title "> Pancit Canton
                                    ...
                                    <p>&emsp; 2 tablespoons oil </p>
                                    <p>&emsp; 12 pieces squid balls - (optional) cut into halves </p>
                                    <p>&emsp; 2 cloves garlic - minced </p>
                                    <p>&emsp; 1 medium onion - chopped </p>
                                    <p>&emsp; 100 grams (3 pieces) chicken liver - (optional) cut into small pieces </p>
                                    <p>&emsp; 150 grams chicken breast fillet - cut into small pieces </p>
                                    <p>&emsp; 10 pieces shrimps - (optional) shells and head removed </p>
                                </a>
                            </p>
                            <div class="collapse" id="collapsepancit-canton">
                                <div class="card card-body" style="border: none;">
                                    <p> 1 piece sausage - (optional) sliced diagonally </p>
                                    <p> 1 big carrot - julienned </p>
                                    <p> 1 cup snow peas (chicharo) - ends trimmed </p>
                                    <p> 1 stalk celery or parsley - (optional) chopped </p>
                                    <p> ½ small cabbage - cut into 8 parts </p>
                                    <p> 3 tablespoons soy sauce </p>
                                    <p> 2 tablespoons oyster sauce </p>
                                    <p> 1 cup chicken broth - see Note 1 </p>
                                    <p> ½ - 1 teaspoon ground pepper </p>
                                    <p> 1 tablespoon cornstarch </p>
                                    <p> 1- 1 ½ cup water </p>
                                    <p> 250 grams pancit canton noodles </p>
                                    <p> salt as needed </p>
                                    <br>
                                    <h6>Directions</h6>
                                    <p> Step 1:</p>
                                    <p> In a wok or large skillet, heat oil over medium heat. Fry the squid balls until cooked and lightly browned. Remove from oil and set aside. </p>
                                    <p> Step 2:</p>
                                    <p> On the same oil, saute garlic and onion until limp and aromatic. </p>
                                    <p> Step 3:</p>
                                    <p> Add chicken meat and cook until no longer pink. Add the chicken liver and cook until almost done. Add shrimps and cook until no longer pink. Toss in the Chinese sausage slices and cook for half a minute. </p>
                                    <p> Step 4:</p>
                                    <p> Lower heat to low. Pour in soy sauce and oyster sauce and stir until well blended. Add the carrots, bell pepper, and snow peas and celery and mix. Cook for about a minute. </p>
                                    <p> Step 5:</p>
                                    <p> Turn up the heat to high and pour in chicken broth and bring to a simmer. Once it simmers, stir in cabbage and cook for a few seconds. </p>
                                    <p> Step 6:</p>
                                    <p> Using a slotted spoon, remove and transfer all the solid ingredients in a bowl leaving only the liquids in the wok. Lower heat to medium. (See Note 2) </p>
                                    <p> Step 7:</p>
                                    <p> UAdd ground pepper to the liquids. Dissolve the cornstarch in 1 cup of water and add this to the wok and bring to simmer.  </p>
                                    <p> Step 8:</p>
                                    <p> Add the noodles and slowly and gently try to push it down to the liquid so it can seep in the flavor. Stir from time until the noodles are almost cooked. You may need to add more water if it dries up and the  </p>
                                    <p> Step 9:</p>
                                    <p> Add back the meat and vegetables and the squid balls. Season with salt as needed. Stir several times to combine and then turn off the heat. </p>
                                    <br>
                                    <h6>Notes</h6>
                                    <p> Note 1:</p>
                                    <p> If you do not have chicken broth, just dissolve 1 chicken broth cube in 1 cup of hot water. </p>
                                    <p> Note 2:</p>
                                    <p> To avoid mushy and limp veggies, just cook them halfway through. It will go on cooking while still hot even after removing them from the wok. Remember that it will also be returned at the last part of cooking. </p>
                                    <p> Note 3:</p>
                                    <p> The pancit canton should be a little saucy once cooked as the noodles will keep on soaking up the liquids even after cooking. </p>
                                </div>
                            </div>
                        </div>
                    </div>
